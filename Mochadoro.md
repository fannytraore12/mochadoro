...
* **Focus State**
  * Red LED & Active Focus: ![Red amber on during focus](app_demo/IMG_4900.jpg)
* **Paused State**
  * UI Pause: ![Paused animation stops and timer pauses](app_demo/paused.png)
  * Hardware Pause: ![Amber LED on and 7-segment displays pause count](app_demo/IMG_4901.jpg)
* **Session Outcomes**
  * Completed Mocha: ![Finished receives coffee and chime](app_demo/mocha.jpg)
  * Burned Coffee (Early Stop): ![Stop early receives burned coffee](app_demo/burned.jpg)
  * Still Coffee (3x Pause Limit): ![Pause 3 times stops timer and receives still coffee](app_demo/still.jpg)
* **Break Interval**
  * Green LED Break: ![Green LED on during break](app_demo/IMG_4903.jpg)
